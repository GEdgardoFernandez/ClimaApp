En este documneto voy a recopilar la mayor cantidad de informacion acerca de la aplciacion;
...
Las tecnologias usadas son HTML, CSS, JavaScript y la API Whater Api (https://api.weatherapi.com) de la cual se extraen los datos del clima.
